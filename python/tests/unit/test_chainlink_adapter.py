...
DataType = _libnautilus.model.DataType
Environment = _libnautilus.common.Environment
LiveNode = _libnautilus.live.LiveNode
TraderId = _libnautilus.model.TraderId
...
def test_chainlink_adapter_imports_and_builder_path():
    ...
    data_type = DataType(ChainlinkData.__name__, {"feed_id": FEED_ID}, FEED_ID)
